 ...
 *
 * Adaptações locais, ambas necessárias e não presentes no original:
...
export default function CountUp({
  ...
  // Sem contagem quando o usuário pede menos movimento: o valor final aparece direto.
  useEffect(() => {
    if (!prefersReducedMotion) return
    if (ref.current) ref.current.textContent = formatValue(direction === 'down' ? from : to)
  }, [prefersReducedMotion, formatValue, direction, from, to])
